...
from glaciation_time_estimator.data_postprocessing.Extract_glaciations import extract_glaciations_whole_year, extract_glaciations_single_period
...
if __name__=="__main__":
    ...
    if config.get("Analyze_year",True):
        ...
        extract_glaciations_single_period(config)
